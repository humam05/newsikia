...
<form action="{{ url('admin/ibu_hamil/periksa_rutin/store') }}" method="POST">
    @csrf
    ...
    <div class="form-row">
        <div class="form-col">
            ...
            <input type="text" class="form-control" value="{{ $identitas->ibu_nama }}" readonly>
        </div>
        <div class="form-col">
            <label>NIK</label>
            <input type="text" class="form-control" value="{{ $identitas->ibu_nik }}" readonly>
        </div>
    </div>
    ...
    <div class="form-row">
        <div class="form-col">
            ...
            <input type="number" step="0.1" name="tfu" class="form-control">
        </div>
        <div class="form-col">
