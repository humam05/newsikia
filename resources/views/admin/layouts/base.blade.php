...
<head>
    ...
    <!-- App css -->
    <link href="{{ url('/template/assets') }}/css/bootstrap.min.css" rel="stylesheet" type="text/css" id="bootstrap-stylesheet" />
    <link href="{{ url('/template/assets') }}/css/icons.min.css" rel="stylesheet" type="text/css" />
    <link href="{{ url('/template/assets') }}/css/app.min.css" rel="stylesheet" type="text/css" id="app-stylesheet" />
    ...
    <div class="right-bar">
        ...
        <div class="slimscroll-menu">
            ...
            <div class="p-4">
                ...
                <div class="mb-2">
                    <img src="{{ url('/template/assets') }}/images/plugins/light.png" class="img-fluid img-thumbnail" alt="" />
                </div>
                ...
                <div class="mb-2">
                    <img src="{{ url('/template/assets') }}/images/plugins/dark.png" class="img-fluid img-thumbnail" alt="" />
                </div>
                <div class="custom-control custom-switch mb-3">
                ...
                <div class="mb-2">
                    <img src="{{ url('/template/assets') }}/images/plugins/rtl.png" class="img-fluid img-thumbnail" alt="" />
                </div>
