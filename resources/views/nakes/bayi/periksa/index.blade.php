...
<div class="button-container">
    <a href="{{ url('/nakes/bayi/identitas') }}" class="btn btn-success">
    ...
    <div class="col-12">
        <section class="card">
            <header class="card-header text-uppercase" style="height: 70px;">
                <form action="{{ url('nakes/bayi/periksa') }}" method="GET"
                    ...
                    <div class="col-md-12">
                        <div class="input-group mb-2">
                            ...
                            @if (request('search'))
                                <div class="input-group-prepend ml-1">
                                    <a href="{{ url('nakes/bayi/periksa') }}" class="btn btn-secondary btn-icon-split">
                                        <span class="icon text-white">
                    ...
                    <tbody>
                        @forelse ($periksaBayi as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('nakes/bayi/periksa/show', $item->id) }}"
                                        class="btn btn-dark btn-sm">Show</a>
                                    <a href="{{ url('nakes/bayi/periksa/edit', $item->id) }}"
                                        class="btn btn-warning btn-sm">Edit</a>
                                    <a href="{{ url('nakes/bayi/periksa/delete', $item->id) }}"
