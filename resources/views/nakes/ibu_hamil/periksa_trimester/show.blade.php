...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-6 detail-group">
            <label class="detail-label"><i class="fas fa-baby-carriage"></i> Umur Kehamilan Berdasarkan USG Trimester 1 (Minggu)</label>
            <div class="detail-value">{{ $periksaTrimester->umur_kehamilan_usg ?? '-' }}</div>
        </div>
    </div>
    ...
    <div class="row mt-4">
        <div class="col-6 detail-group">
            ...
            <div class="detail-value" style="white-space: pre-wrap;">{{ $periksaTrimester->rencana_konsultasi ?? '-' }}</div>
        </div>
        <div class="col-6 detail-group">
            <label class="detail-label"><i class="fas fa-file-medical"></i> Rencana Melahirkan</label>
            <div class="detail-value" style="white-space: pre-wrap;">{{ $periksaTrimester->rencana_melahirkan ?? '-' }}</div>
        </div>
        <div class="col-6 detail-group">
            <label class="detail-label"><i class="fas fa-file-medical"></i> Rencana Kontrasepsi</label>
            <div class="detail-value" style="white-space: pre-wrap;">{{ $periksaTrimester->rencana_kontrasepsi ?? '-' }}</div>
        </div>
        <div class="col-6 detail-group">
            <label class="detail-label"><i class="fas fa-file-medical"></i> Konseling</label>
            <div class="detail-value" style="white-space: pre-wrap;">{{ $periksaTrimester->konseling ?? '-' }}</div>
        </div>
    </div>
</div>
