...
# Simple - The most complete web ui kit and dashboard template

Thank you for purchasing Simple :). The following guideline will help you to get started with Simple and its documentation.
