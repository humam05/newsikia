        ...
        <div class="col-12">
            <section class="card">
                <header class="card-header text-uppercase" style="height: 70px;">
                    <form action="{{ url('nakes/ibu_hamil/periksa_rutin') }}" method="GET"
                            ...
                            @forelse ($periksa_rutin as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ url('nakes/ibu_hamil/periksa_rutin/edit', $item->id) }}"
                                            class="btn btn-warning btn-sm">Edit</a>
                                        <a href="{{ url('nakes/ibu_hamil/periksa_rutin/delete', $item->id) }}"
