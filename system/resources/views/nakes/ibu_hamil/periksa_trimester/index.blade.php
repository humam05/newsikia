...
@section('content')
    ...
    <div class="button-container">
        <a href="{{ url('/nakes/ibu_hamil/identitas') }}" class="btn btn-success">
        ...
        <div class="col-12">
            <section class="card">
                <header class="card-header text-uppercase" style="height: 70px;">
                    <form action="{{ url('nakes/ibu_hamil/periksa_trimester') }}" method="GET"
                        ...
                        <tbody>
                            @forelse ($periksa_trimester as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ url('nakes/ibu_hamil/periksa_trimester/show', $item->id) }}"
                                            class="btn btn-dark btn-sm">Show</a>
                                        <a href="{{ url('nakes/ibu_hamil/periksa_trimester/edit', $item->id) }}"
                                            class="btn btn-warning btn-sm">Edit</a>
                                        <a href="{{ url('nakes/ibu_hamil/periksa_trimester/delete', $item->id) }}"
