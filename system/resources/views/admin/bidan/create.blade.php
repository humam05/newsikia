    ...
    <form action="{{ url('/admin/bidan/store') }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="mb-3 col-6">
                ...
                <input type="text" name="provinsi" id="provinsi" class="form-control" placeholder="Masukkan Email"
                    required>
            </div>

            <div class="mb-3 col-6">
                <label for="kabupaten" class="form-label">Kabupaten</label>
                <input type="text" name="kabupaten" id="kabupaten" class="form-control" placeholder="Masukkan Kabupaten"
                    required>
            </div>
        </div>
        <div class="row">
