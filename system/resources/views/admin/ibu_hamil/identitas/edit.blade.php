...
<body>
    <div class="container">
        <div class="card">
            ...
            <form action="{{ url('admin/ibu_hamil/identitas/update', $detail->id) }}" method="POST">
                @csrf
                <div class="mb-4">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{ url('admin/ibu_hamil/identitas') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i>
                        Batal</a>
                </div>
            </form>
        </div>
